...
import 'package:driver_safe_app/user/carInforScreen.dart';
...
class _Register extends State<RegisterScreen> {
  ...
  final TextEditingController kinSexController = TextEditingController();
              ...
              children:[
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                      filled: true,
                      fillColor: Colors.white,
                      hintText: "Please enter your NIN",
                      border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(10),
                          borderSide: BorderSide.none
                      ),
                ...
                SizedBox(height: 20),
                TextField(
                  controller: kinSexController,
                  decoration: InputDecoration(
                      filled: true,
                      fillColor: Colors.white,
                      hintText: "Next of kin Sex",
                      border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(10),
                          borderSide: BorderSide.none
                      ),
  ...
  void registerNewUser(BuildContext context) async
  {
      ...
      if(firebaseUser != null)
      {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => CarInforScreen())
        );
